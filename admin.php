...
if (isset($_POST['btn'])) {
	...
	echo '<span style="background: none repeat scroll 0% 0% rgb(255, 133, 102); padding: 10px 20px; line-height: 35px; float: left; clear: both; border-radius: 4px; font-family: arial; font-style: italic;">&lt;script id="age-verification-script" type="text/javascript" src="https://github.com/openthinkgroup/shopify_testing/age-verification.jquery.js?'.$sid.'"&gt;&lt;/script&gt;</span>';
